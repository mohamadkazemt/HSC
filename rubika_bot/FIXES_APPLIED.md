...
## 🚀 به‌روزرسانی 2025-11-08

- مهاجرت کامل از API قدیمی Rubika به کتابخانه **RubPy** همراه با ثبت هندلرها.
- رمزنگاری توکن ربات با استفاده از `django-cryptography` و اضافه شدن اعتبارسنجی.
- اضافه شدن rate limiting برای وبهوک، صفحه‌بندی در پنل مدیریت و تسک دوره‌ای برای پاک‌سازی لاگ‌ها.
- بازنویسی کامل سرویس‌ها و ویوها با Type Hint و Docstring برای نگهداشت بهتر.
