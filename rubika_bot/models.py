...
class GymReferralState(models.Model):
    """Persistent conversation state for the gym referral flow."""

    rubika_user = models.OneToOneField(
        RubikaUser, on_delete=models.CASCADE, related_name="gym_referral_state"
    )
