...
class Contractor(models.Model):
    ...
    liability_insurance_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای بیمه مسئولیت مدنی")
    ...
    fire_insurance_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای بیمه آتش‌سوزی")
    contractor_certificate_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای صلاحیت پیمانکاری")
    safety_certificate_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای صلاحیت ایمنی")
...
class Employee(models.Model):
    ...
    entry_permit_expiration = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای مجوز ورود")
...
class Vehicle(models.Model):
    ...
    insurance_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای بیمه‌نامه")
    ...
    permit_expiry = models.DateField(null=True, blank=True, verbose_name="تاریخ انقضای آخرین مجوز خودرو")
...
class Report(models.Model):
    ...
    report_datetime = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ و زمان ثبت گزارش")
    report_date = models.DateField(null=True, blank=True, verbose_name="تاریخ گزارش")
