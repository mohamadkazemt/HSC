...
from contractor_management.models import Contractor , Employee # ایمپورت مدل پیمانکار
...
class IncidentReport(models.Model):
    ...
    involved_person = models.ManyToManyField(UserProfile, blank=True, related_name="involved_incidents", verbose_name="اشخاص مرتبط با حادثه")
    involved_equipment = models.TextField(blank=False, default="",verbose_name="تجهیزات مرتبط با حادثه") # مقدار پیش فرض اضافه شد
    ...
    related_contractor = models.ForeignKey(Contractor, on_delete=models.SET_NULL, null=True, blank=True, related_name="incidents", verbose_name="پیمانکار مرتبط")
    related_contractor_employees = models.ManyToManyField(Employee, blank=True, related_name="contractor_incidents", verbose_name="پرسنل پیمانکار مرتبط")
    ...
    report_author = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, null=True, related_name="authored_incidents", verbose_name="نویسنده گزارش")
