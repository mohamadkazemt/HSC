...
class IncidentReport(models.Model):
    ...
    location = models.ForeignKey(Location, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="سایت حادثه")
    ...
    def __str__(self):
        return f"گزارش حادثه {self.incident_date} - {self.location} - {self.section}"
