...
# مدل نهایی گزارش شیفت
class ShiftReport(models.Model):
    shift_date = models.DateField(verbose_name="تاریخ شیفت", default=get_shift_for_date)
    loading_operations = models.ManyToManyField(LoadingOperation, verbose_name="عملیات بارگیری")
    shift_leaves = models.ManyToManyField(ShiftLeave, verbose_name="مرخصی‌های شیفت")
    vehicle_reports = models.ManyToManyField(VehicleReport, verbose_name="گزارش‌های خودرو")
    mining_machine_reports = models.ManyToManyField(MiningMachineReport, verbose_name="گزارش‌های دستگاه‌های معدنی")
    supervisor_comments = models.TextField(blank=True, verbose_name="توضیحات سرشیفت برای شیفت بعد")

    def __str__(self):
        return f"گزارش شیفت {self.shift_date}"
